...
//  DesignCode
//
//  Created by Felix Lin on 4/13/20.
    ...
    var body: some View {
        ZStack {
            Image(systemName: "sun.max")
                ...
                .rotation3DEffect(Angle(degrees: press ? 20 : 0), axis: (x: 10, y: 0, z: 0))
        ...
        .background(
            ZStack {
                ...
                Circle()
                    ...
                    .shadow(color: Color(#colorLiteral(red: 0.8980392157, green: 0.9333333333, blue: 1, alpha: 1)), radius: 3, x: -5, y: -5)
            ...
            .clipShape(Circle())
            .shadow(color: Color(press ? #colorLiteral(red: 0.8980392157, green: 0.9333333333, blue: 1, alpha: 1) : #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)), radius: 20, x: -20, y: -20)
            .shadow(color: Color(press ? #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1) : #colorLiteral(red: 0.8980392157, green: 0.9333333333, blue: 1, alpha: 1)), radius: 20, x: 20, y: 20)
            .scaleEffect(tap ? 1.2 : 1)
            .gesture(
